...
# CORS settings for Vercel / Render / Localhost
...
DEFAULT_FROM_EMAIL = os.getenv('DEFAULT_FROM_EMAIL', '').strip() or (f"Priya - Digital Growth Hub <{_email_user}>" if _email_user else 'Priya - Digital Growth Hub <noreply@digitalgrowthhub.ai>')
